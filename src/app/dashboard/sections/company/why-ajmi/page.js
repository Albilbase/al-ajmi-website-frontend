...
export default function WhyAjamiManager() {
    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        if (response.status === 200 && response.data) {
          const whySections = response.data.filter(
            (s) => s.section_key === "why_ajami",
          );
          ...
          const expertiseHeader = whySections.find(
            (s) => s.type === "expertise_header",
          );
          const expertiseItems = whySections.filter(
            (s) => s.type === "expertise_item",
          );
          setContent((prev) => ({
            ...prev,
            expertise: {
  ...
  const removeImage = async (section) => {
    ...
    if (targetId && targetImage) {
      const result = await confirmDelete(
        "حذف الصورة",
        "هل أنت متأكد من حذف الصورة نهائياً من السيرفر؟",
      );
  ...
  const addContentSection = () => {
    const maxOrder = content.contentSections.reduce(
  ...
  const removeContentSection = async (localId) => {
    ...
    setContent((prev) => ({
      ...prev,
      contentSections: prev.contentSections.filter(
        (s) => s.localId !== localId,
      ),
    }));
  };
  ...
  const saveContentSection = async (localId) => {
    ...
    formData.append(
      "details",
      JSON.stringify({ image_position: section.imagePosition }),
    );
  ...
  const addExpertiseItemFromModal = async () => {
    ...
    try {
      ...
      setContent((prev) => ({
        ...
        expertise: {
          ...prev.expertise,
          list: [...prev.expertise.list, addedItem],
        },
      }));
      ...
      <div className={localStyles.header}>
        <div>
          <h2 className={dashboardStyles.sectionTitle}>
            Why Al-Ajmi Management
          </h2>
          <p className={dashboardStyles.sectionSubtitle}>
            Manage hero, dynamic content sections, expertise grid, and offices.
          </p>
        </div>
      </div>
      ...
      <div className={localStyles.sectionGrid}>
          ...
          <div className={localStyles.formGrid}>
            <div className={localStyles.inputGroup}>
              ...
              <input
                ...
                onChange={(e) =>
                  handleUpdate("hero", "subtitle_en", e.target.value)
                }
            ...
            <div dir="rtl" className={localStyles.inputGroup}>
              ...
              <input
                ...
                onChange={(e) =>
                  handleUpdate("hero", "subtitle_ar", e.target.value)
                }
                className={localStyles.inputField}
              />
            </div>
        ...
        <div className={dashboardStyles.contentCard}>
          ...
          {content.contentSections.map((section, index) => (
            <div
              key={section.localId}
              className={localStyles.dynamicSectionCard}
            >
              <div className={localStyles.dynamicSectionHeader}>
                <div className={localStyles.dynamicSectionTitle}>
                  ...
                  <span>
                    Section {index + 1}
                    {section.title_en ? `: ${section.title_en}` : ""}
                  </span>
                </div>
                <div className={localStyles.dynamicSectionActions}>
                  ...
                  <button
                    onClick={() => saveContentSection(section.localId)}
                    disabled={isSubmitting}
                  ...
                  <button
                    onClick={() => removeContentSection(section.localId)}
              ...
              <div className={localStyles.formGrid}>
                <div className={localStyles.inputGroup}>
                  ...
                  <input
                    ...
                    className={`${localStyles.inputField} ${formErrors.content_title_en ? dashboardStyles.invalidInput : ""}`}
                  />
                </div>
                <div dir="rtl" className={localStyles.inputGroup}>
                  ...
                  <input
                    ...
                    className={`${localStyles.inputField} ${formErrors.content_title_ar ? dashboardStyles.invalidInput : ""}`}
                  />
                </div>
              </div>
        ...
        <div className={dashboardStyles.contentCard}>
          ...
          <div className={localStyles.formGrid}>
            <div className={localStyles.inputGroup}>
              ...
              <input
                ...
                onChange={(e) =>
                  handleUpdate("expertise", "title_en", e.target.value)
                }
            ...
            <div dir="rtl" className={localStyles.inputGroup}>
              ...
              <input
                ...
                onChange={(e) =>
                  handleUpdate("expertise", "title_ar", e.target.value)
                }
          ...
          <div className={localStyles.formGrid}>
            <div className={localStyles.inputGroup}>
              <label className={localStyles.fieldLabel}>
                Expertise Description (EN)
              </label>
              <textarea
                rows="4"
                value={content.expertise.text_en}
                onChange={(e) =>
                  handleUpdate("expertise", "text_en", e.target.value)
                }
                className={localStyles.textareaField}
              />
            </div>
            <div dir="rtl" className={localStyles.inputGroup}>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleUpdate("expertise", "text_ar", e.target.value)
                }
                className={localStyles.textareaField}
              />
            </div>
              ...
              {content.expertise.list.map((item, idx) => (
                <div key={item.id || idx} className={localStyles.listItem}>
                  <textarea
                    ...
                    value={item.en}
                    onChange={(e) =>
                      handleListUpdate(idx, "en", e.target.value)
                    }
                    className={localStyles.textareaField}
                    rows="2"
                  />
                  <div dir="rtl">
                    <textarea
                      ...
                      value={item.ar}
                      onChange={(e) =>
                        handleListUpdate(idx, "ar", e.target.value)
                      }
                      className={localStyles.textareaField}
                      rows="2"
                    />
                  ...
                  <div style={{ display: "flex", gap: "0.5rem" }}>
                    ...
                    <button
                      onClick={() => removeExpertiseItem(item.id, idx)}
                      className={localStyles.removeBtn}
                    >
                      <Trash2 size={18} />
                    </button>
        ...
        <div className={dashboardStyles.contentCard}>
          ...
          <div className={localStyles.formGrid}>
            <div className={localStyles.inputGroup}>
              ...
              <input
                value={content.offices.title_en}
                onChange={(e) =>
                  handleUpdate("offices", "title_en", e.target.value)
                }
                className={`${localStyles.inputField} ${formErrors.offices_title_en ? dashboardStyles.invalidInput : ""}`}
              />
            </div>
            <div dir="rtl" className={localStyles.inputGroup}>
              <label className={localStyles.fieldLabel}>
              ...
              <input
                value={content.offices.title_ar}
                onChange={(e) =>
                  handleUpdate("offices", "title_ar", e.target.value)
                }
                className={`${localStyles.inputField} ${formErrors.offices_title_ar ? dashboardStyles.invalidInput : ""}`}
              />
            </div>
          </div>
          <div className={localStyles.formGrid}>
            <div className={localStyles.inputGroup}>
              ...
              <textarea
                rows="3"
                value={content.offices.text_en}
                onChange={(e) =>
                  handleUpdate("offices", "text_en", e.target.value)
                }
                className={localStyles.textareaField}
              />
            </div>
            <div dir="rtl" className={localStyles.inputGroup}>
              ...
              <textarea
                rows="3"
                value={content.offices.text_ar}
                onChange={(e) =>
                  handleUpdate("offices", "text_ar", e.target.value)
                }
                className={localStyles.textareaField}
              />
            </div>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button
              onClick={addExpertiseItemFromModal}
